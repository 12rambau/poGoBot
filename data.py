...
commandex = {
    "help":             "@pogobot",
    "add (pas éclos)":  "!add Tniveau hh:mm lieu (avec hh:mm l'heure d'éclosion, ex : !add T4 10:15 aire de jeux)",
    "add (éclos)":      "!add pokemon hh:mm lieu (avec hh:mm l'heure de fin, ex : !add magicarpe 14:30 jazz)",
    "launch":           "!launch hh:mm",
    "edit":             "!edit pokemon",
    "chef":             "!chef @pseudo",
    "in":               "!in",
    ...
    "free":             "!free @pseudo",
    "cookie":           "!cookie",
    "add (ex)":         "!add ex dd/mm/yyy hh:mm lieu",
    }
